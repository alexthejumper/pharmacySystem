...
{
    public partial class viewProductChildren : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String searchMed = "select Med_ID, Med_Name, Med_Description, Price, Medicine_Reaction, Permissible_Dose, Med_Image from medicine where med_category = 'MOTHER'";
            SqlDataAdapter sqlDa = new SqlDataAdapter(searchMed, con);
            DataTable dtbl = new DataTable();
            sqlDa.Fill(dtbl);
            gvMotherProducts.DataSource = dtbl;
            gvMotherProducts.DataBind();
        }
    }
}