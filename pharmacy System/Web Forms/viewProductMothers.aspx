<%@ Page Title="" Language="C#" MasterPageFile="~/Master Pages/HomePage.Master" AutoEventWireup="true" CodeBehind="viewProductMothers.aspx.cs" Inherits="pharmacy_System.Web_Forms.viewProductChildren" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $(".mother").prepend($("<thead></thead>").append($(this).find("tr:first"))).DataTable();
        });
    </script>
    ...
    <div class="container">
        <div class="row">
            <div style="background-color: white; margin: 50px 0; padding: 30px; border-radius: 5px;">
                <asp:GridView ID="gvMotherProducts" CssClass="mother dt-responsive table table-striped table-bordered" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal">
                <Columns>
